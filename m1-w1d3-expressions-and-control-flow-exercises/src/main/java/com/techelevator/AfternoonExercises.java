...
public class AfternoonExercises {
	...
	public boolean posNeg(int a, int b, boolean negative) {
		 if ((a < 0 && b < 0) && negative == false)
				return false;
		 else if( ((a < 0 && b < 0 && negative == true)) || ((a < 0 || b < 0) && negative == false))
		return true;
	...
	public int max1020(int a, int b) {
		if ((a > 20 || a < 10) && (b > 20 || b < 10))
			return 0;
		else if (((a > b) && (a > 9 && a < 21) || (b > a)  && b > 20 ))
			return a;
		else if (((b > a) && (b > 9 && b < 21) || (a > b) && a > 20))
			return b;
	...
	public boolean cigarParty(int cigars, boolean isWeekend) {
		if (cigars > 39 && cigars < 61 && isWeekend == false)
			return true;
		else if ( cigars >39 && isWeekend == true)
		return true;
		else return false;
	}
	 ...
	 * is 0 (no). Otherwise the result is 1 (maybe). dateFashion(5, 10) → 2
	 * dateFashion(5, 2) → 0 dateFashion(5, 5) → 1
	 */
	 ...
	 * squirrels play and false otherwise. squirrelPlay(70, false) → true
	 * squirrelPlay(95, false) → false squirrelPlay(95, true) → true
	 */
	 ...
	 * speed can be 5 higher in all cases. caughtSpeeding(60, false) → 0
	 * caughtSpeeding(65, false) → 1 caughtSpeeding(65, true) → 0
	 */
	public int caughtSpeeding(int speed, boolean isBirthday) {
		...
		return 0;
			...
			return 1;
		else if ((speed >=81 && isBirthday == false) || (speed >= 86 && isBirthday == true))
		return 2;
		else return 0;
	 ...
	 * should be "off". alarmClock(1, false) → "7:00" alarmClock(5, false) →
	 * "7:00" alarmClock(0, false) → "10:00"
	 */
	 ...
	 * less or equal to 1, or greater or equal to 10. in1To10(5, false) → true
	 ...
	 * number is special. (Hint: Think "mod".) specialEleven(22) → true
	 * specialEleven(23) → true specialEleven(24) → false
	 */
	 ...
	 * but not both. (Hint: Think "mod".) old35(3) → true old35(10) → true
	 * old35(15) → false
	 */
	 ...
	 * false. (Hint: Think "mod".) less20(18) → true less20(19) → true
	 * less20(20) → false
	 */
	 ...
	 * (7 % 5) is 2. nearTen(12) → true nearTen(17) → false nearTen(19) → true
	 */
	public boolean nearTen(int num) {
		if (((( num + 1 ) % 10 == 0) || (num % 10 == 0) || ((num + 2) % 10 == 0)))
			return true;
		else if (((( num - 1 ) % 10 == 0) || (num % 10 == 0) || ((num - 2) % 10 == 0)))
			return true;
		else
		return false;
	}
	 ...
	 * teen, just return 19. teenSum(3, 4) → 7 teenSum(10, 13) → 19 teenSum(13,
	 * 2) → 19
	 */
	 ...
	 * answerCell(false, false, false) → true answerCell(false, false, true) →
	 * false answerCell(true, false, false) → false
	 */
	 ...
	 * party is always bad (0). teaParty(6, 8) → 1 teaParty(3, 8) → 0
	 * teaParty(20, 6) → 2
	 */
	 ...
	 * the ints to get the third. twoAsOne(1, 2, 3) → true twoAsOne(3, 1, 2) →
	 * true twoAsOne(3, 2, 2) → false
	 */
	 ...
	 * not need to be greater than a. inOrder(1, 2, 4, false) → true inOrder(1,
	 * 2, 1, false) → false inOrder(1, 1, 2, true) → true
	 */
	 ...
	 * 7 or 5 5 5. inOrderEqual(2, 5, 11, false) → true inOrderEqual(5, 7, 6,
	 * false) → false inOrderEqual(5, 5, 7, true) → true
	 */
	public boolean inOrderEqual(int a, int b, int c, boolean equalOk) {
		if (( (c > b) && (b > a) && (equalOk == false)) || ( (c >= b) && (b >= a) && (equalOk == true)))
			return true;
	 ...
	 * the sum. loneSum(1, 2, 3) → 6 loneSum(3, 2, 3) → 2 loneSum(3, 3, 3) → 0
	 */
	 ...
	 * c do not count. luckySum(1, 2, 3) → 6 luckySum(1, 2, 13) → 3 luckySum(1,
